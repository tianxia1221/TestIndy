...
public class PoolUtils {
	...
	private static final String DEFAULT_POOL_NAME = "pool1";
	...
	private static File createGenesisTxnFile(String filename) throws IOException {
		...
		String[] defaultTxns = new String[] { String.format(
	...
	public static String createPoolLedgerConfig()
			throws IOException, InterruptedException, java.util.concurrent.ExecutionException, IndyException {
	...
	public static void closePool() throws InterruptedException, ExecutionException, IndyException {
		pool.closePoolLedger().get();
	}

	
	public static void deletePool() throws InterruptedException, ExecutionException, IndyException {
		Pool.deletePoolLedgerConfig(PoolUtils.getPoolName()).get();
	}
	...
	public static Pool getPool(){
		...
		} catch (ExecutionException |IOException | InterruptedException | IndyException e) {
		...
		try {
			pool = Pool.openPoolLedger(DEFAULT_POOL_NAME, "{}").get();
